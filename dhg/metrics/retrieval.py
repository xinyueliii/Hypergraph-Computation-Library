...
def ap(
    ...
    pred_seq = y_true[torch.argsort(y_pred, descending=True)][:k]
    pred_index = torch.arange(1, len(pred_seq) + 1, device=y_true.device)[pred_seq > 0]
